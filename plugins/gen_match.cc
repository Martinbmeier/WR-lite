...
double gen_match::transverseSphericity(math::XYZTLorentzVector p1, math::XYZTLorentzVector p2, math::XYZTLorentzVector p3){
...
void gen_match::saveElectronData(eventBits * myRECOevent,double matched1Mass, double matched2Mass){
		std::ofstream myfile;
...
void gen_match::saveMuonData(eventBits * myRECOevent, double matched1Mass, double matched2Mass){
		std::ofstream myfile;
		myfile.open (m_dataSaveFile, std::ios_base::app);
