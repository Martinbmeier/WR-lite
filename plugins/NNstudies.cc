...
class NNstudies : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
	...
	private:
		...
		void csvTable(const reco::GenParticle*, const reco::GenParticle*, const reco::GenParticle*, const reco::GenParticle*, const reco::GenParticle*, const reco::GenParticle*, int binNumber, const pat::Muon*, const pat::Electron*, const reco::GenJet*, const reco::GenJet*, math::XYZTLorentzVector combinedJets, const pat::MET, double weight);
...
NNstudies::NNstudies(const edm::ParameterSet& iConfig)
	...
	m_packedGenParticlesToken (consumes<std::vector<reco::Candidate>> (iConfig.getParameter<edm::InputTag>("packedGenParticles"))),
...
NNstudies::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  eventInfo myEvent; 
	...
	edm::Handle<std::vector<reco::Candidate>> packedGenParticles;
